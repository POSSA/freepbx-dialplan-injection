...
// compare version numbers of local module.xml and remote module.xml on POSSA dev site
// returns true if a new version is available
function dialplaninjection_vercheck() {
	$newver = false;
	$module_local = dialplaninjection_xml2array("modules/dialplaninjection/module.xml");
	$module_remote = dialplaninjection_xml2array("https://raw.github.com/POSSA/freepbx-dialplan-injection/master/module.xml");
...
function dialplaninjection_xml2array($url, $get_attributes = 1, $priority = 'tag')  {
	$contents = "";
